...
- [Casbin的代码使用、api调用、自定义比较方法](https://www.bilibili.com/video/BV13r4y1M7AC/)
...
- [Building Dynamic Authorization Systems with Casbin and the PERM Model – LogRocket Blog](https://blog.logrocket.com/building-dynamic-authorization-systems-with-casbin-and-the-perm-model/?spm=5176.28103460.0.0.14e67551FWN1PG)
- [Understanding the PERM Metamodel in Casbin – Auth0 Community](https://community.auth0.com/t/understanding-the-perm-metamodel-in-casbin/84321?spm=5176.28103460.0.0.14e67551FWN1PG)
...
- [GIn + Casbin: RBAC 权限控制系统集成](https://blog.csdn.net/qq_44376306/article/details/157297099)
...
<Tab value="Java">
- [Casbin 官方 Java 仓库](https://github.com/casbin/jcasbin)
- [权限框架之jcasbin讲解](https://www.cnblogs.com/jingzh/p/17676407.html#1-jcasbin)
- [SpringBoot整合jasbin实现RBAC权限管理](https://segmentfault.com/a/1190000040096256)
